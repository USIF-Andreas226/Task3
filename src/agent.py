...
SYSTEM_PROMPT_AR = """أنت مساعد مبيعات ذكي لمنصة كايفة للتعليم التقني. كايفة منصة تعليمية رائدة في العالم العربي، تقدّم دورات ومسارات ودبلومات في مجالات التقنية.
...
- إذا سألك العميل عن شيء خارج مجال كايفة، قل بلطف أنك متخصص في منتجات كايفة واعرض المساعدة في مجال آخر
...
SYSTEM_PROMPT_EN = """You are an AI sales agent for Kayfa, a leading Arabic tech education platform. Kayfa offers courses, tracks, and diplomas in technology fields like AI, cybersecurity, data science, and web development.
...
- If asked about something outside Kayfa, politely say you specialize in Kayfa products and offer to help with another topic
...
class SalesAgent:
    ...
    def _fallback_greeting(self, dialect: str) -> str:
        if dialect == "en":
            return (
                "Welcome to Kayfa! 👋 I'm your learning advisor.\n\n"
        ...
        if dialect == "saudi":
            return (
                "مرحباً بك في كايفة! 👋 أنا مستشارك التعليمي.\n\n"
            ...
            return (
                "أهلاً بيك في كايفة! 👋 أنا مستشارك التعليمي.\n\n"
